...
include_once('../Commons.php');
    ...
    * @return 
   */
	function GetSupply_order_historyById($params) {
		
		$resource = 'supply_order_histories';
		$resourceSingle = 'supply_order_history';
    ...
    * @return 
   */
	function GetSupply_order_histories($params) {
    ...
    * @return 
   */
	function CreateSupply_order_history($params) {
    ...
    * @return 
   */
	function UpdateSupply_order_history($params) {
    ...
    * @return 
   */
	function DeleteSupply_order_history($params) {
	...
	if ($soap_ws_custom_on==1){
		...
		/** SOAP SERVER **/
		$server = new SoapServer(WSDL_supply_order_histories);
		
		/* Add Functions */
		$server->addFunction("GetSupply_order_histories");
		$server->addFunction("GetSupply_order_historyById");
		$server->addFunction("CreateSupply_order_history");
		$server->addFunction("UpdateSupply_order_history");
		$server->addFunction("DeleteSupply_order_history");
