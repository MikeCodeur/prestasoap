...
include_once('../Commons.php');
    ...
    * @return 
   */
	function GetCombinationById($params) {
		
		$resource = 'combinations';
		$resourceSingle = 'combination';
    ...
    * @return 
   */
	function GetCombinations($params) {
    ...
    * @return 
   */
	function CreateCombination($params) {
    ...
    * @return 
   */
	function UpdateCombination($params) {
    ...
    * @return 
   */
	function DeleteCombination($params) {
	...
	if ($soap_ws_custom_on==1){
		...
		/** SOAP SERVER **/
		$server = new SoapServer(WSDL_COMBINATIONS);
		
		/* Add Functions */
		$server->addFunction("GetCombinations");
		$server->addFunction("GetCombinationById");
		$server->addFunction("CreateCombination");
		$server->addFunction("UpdateCombination");
		$server->addFunction("DeleteCombination");

		$server->handle();
		
	}else{
		echoXmlMessageWSDisabled('Combination');
	}
?> 