...
include_once('../Commons.php');
   ...
   */
	...
	if ($soap_ws_custom_on==1){
		...
		/** SOAP SERVER **/
		$server = new SoapServer(WSDL_suppliers);
		
		/* Add Functions */
		$server->addFunction("GetSuppliers");
		$server->addFunction("GetSupplierById");
		$server->addFunction("CreateSupplier");
		$server->addFunction("UpdateSupplier");
		$server->addFunction("DeleteSupplier");
