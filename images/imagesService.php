...
include_once('../Commons.php');
   ...
   */
	...
	if ($soap_ws_custom_on==1){
		...
		/** SOAP SERVER **/
		$server = new SoapServer(WSDL_ZONES);
		
		/* Add Functions */
		$server->addFunction("GetZones");
		$server->addFunction("GetZoneById");
		$server->addFunction("CreateZone");
		$server->addFunction("UpdateZone");
		$server->addFunction("DeleteZone");
