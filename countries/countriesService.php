...
include_once('../Commons.php');
    ...
    * @return 
   */
	function GetCountryById($params) {
		
		$resource = 'countries';
		$resourceSingle = 'country';
   ...
   */
	...
	if ($soap_ws_custom_on==1){
		...
		/** SOAP SERVER **/
		$server = new SoapServer(WSDL_countries);
		
		/* Add Functions */
		$server->addFunction("GetCountries");
		$server->addFunction("GetCountryById");
		$server->addFunction("CreateCountry");
		$server->addFunction("UpdateCountry");
		$server->addFunction("DeleteCountry");
