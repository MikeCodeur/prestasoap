...
include_once('../Commons.php');
    ...
    * @return 
   */
	function GetStockById($params) {
		
		$resource = 'stocks';
		$resourceSingle = 'stock';
   ...
   */
	...
	if ($soap_ws_custom_on==1){
		...
		/** SOAP SERVER **/
		$server = new SoapServer(WSDL_stocks);
		
		/* Add Functions */
		$server->addFunction("GetStocks");
		$server->addFunction("GetStockById");
		$server->addFunction("CreateStock");
		$server->addFunction("UpdateStock");
		$server->addFunction("DeleteStock");
