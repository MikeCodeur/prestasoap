...
include_once('../Commons.php');
    ...
    * @return 
   */
	function GetOrder_historyById($params) {
		
		$resource = 'order_histories';
		$resourceSingle = 'order_history';
    ...
    * @return 
   */
	function GetOrder_histories($params) {
    ...
    * @return 
   */
	function CreateOrder_history($params) {
    ...
    * @return 
   */
	function UpdateOrder_history($params) {
    ...
    * @return 
   */
	function DeleteOrder_history($params) {
	...
	if ($soap_ws_custom_on==1){
		...
		/** SOAP SERVER **/
		$server = new SoapServer(WSDL_ORDER_HISTORIES);
		
		/* Add Functions */
		$server->addFunction("GetOrder_histories");
		$server->addFunction("GetOrder_historyById");
		$server->addFunction("CreateOrder_history");
		$server->addFunction("UpdateOrder_history");
		$server->addFunction("DeleteOrder_history");

		$server->handle();
		
	}else{
		echoXmlMessageWSDisabled('Order_history');
	}
?> 